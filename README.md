# first-comfy-workflow

Dockerized ComfyUI workflow: first-comfy-workflow.json
...
docker build -t first-comfy-workflow .

# Run the container
docker run -p 8188:8188 first-comfy-workflow
```

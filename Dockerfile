...
RUN wget -q -O /comfyui/models/loras/ton_lora.safetensors "https://civitai.com/api/download/models/287544?type=Model&format=SafeTensor&token=4f8b571f0f01b15def8cd0ee37713afa"
